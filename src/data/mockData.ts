...
export const mockPets: Pet[] = [
  {
    ...
    description:
      "Luna is a gentle, loving companion who adores people and playtime. She's well-trained, great with kids, and would make the perfect family dog.",
    weight: "28 kg",
  ...
  },
  {
    ...
    adoptionStatus: "available",
    description:
      "Whiskers is a calm, independent cat who loves cozy spots and gentle pets. Perfect for a quiet home.",
    weight: "4 kg",
  ...
  },
  {
    ...
    adoptionStatus: "available",
    description:
      "Max is a loyal, protective companion. Well-trained and great with families who have space for an active dog.",
    weight: "35 kg",
  ...
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1573865526739-10c1d3a1f0cc?w=800&h=800&fit=crop",
      "https://images.unsplash.com/photo-1518791841217-8f162f1e1131?w=800&h=800&fit=crop",
    ],
    healthStatus: "vaccinated",
    adoptionStatus: "available",
    description:
      "Bella is a playful kitten with a fluffy coat and loving personality. She loves to play and cuddle.",
    weight: "2.5 kg",
  ...
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1612536981698-808595f2f0a6?w=800&h=800&fit=crop",
    ],
    healthStatus: "vaccinated",
    adoptionStatus: "available",
    description:
      "Charlie is a curious, friendly beagle who loves adventures and treats. Great with kids and other pets.",
    weight: "12 kg",
  ...
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1478098711619-5ab0b478d6e6?w=800&h=800&fit=crop",
      "https://images.unsplash.com/photo-1519052537078-e6302a4968d4?w=800&h=800&fit=crop",
    ],
    healthStatus: "healthy",
    adoptionStatus: "available",
    description:
      "Mittens is a tiny, adorable kitten full of energy and curiosity. She loves to play and explore.",
    weight: "1.2 kg",
  ...
  },
  {
    ...
    adoptionStatus: "available",
    description:
      "Rocky is a gentle giant who needs special care. He's loving, calm, and would thrive in a patient home.",
    weight: "32 kg",
    ...
    medical: {
      ...
      notes:
        "Has mild hip dysplasia. Needs gentle exercise and joint supplements.",
    },
    shelter: {
      name: "Kathmandu Animal Shelter",
      contact: "+977 98-1234567",
  ...
  },
  {
    ...
    description:
      "Simba is a confident, social cat who loves attention. He's vocal and will let you know what he wants!",
    weight: "5 kg",
...
export const mockShelters: Shelter[] = [
  ...
  },
  {
    ...
    distance: "12.7 km",
    image:
      "https://images.unsplash.com/photo-1444212477490-ca407925329e?w=400&h=300&fit=crop",
    petsAvailable: 31,
  },
];
